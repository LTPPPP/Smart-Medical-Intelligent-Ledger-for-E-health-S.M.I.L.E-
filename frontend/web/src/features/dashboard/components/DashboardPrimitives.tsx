    ...
    <div className="flex flex-wrap items-center justify-between gap-4">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <h1 className="font-poppins text-[26px] font-bold tracking-tight text-smile-primary-dark">{title}</h1>
...
export function DashStat({
  ...
  if (accent) {
    return (
      ...
      >
        ...
        <p className="mt-1.5 font-poppins text-2xl font-bold text-white">{loading ? '—' : value}</p>
  ...
  return (
    ...
    >
      ...
      <p className="mt-1.5 font-poppins text-2xl font-bold text-smile-primary-dark">{loading ? '—' : value}</p>
...
export function DashPanel({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 border-b px-6 py-4" style={{ borderColor: 'var(--surface-panel-border)' }}>
...
export function DashError({ label = 'Something went wrong.', onRetry }: { label?: string; onRetry?: () => void }) {
  return (
    <div
...
export function DashQuickLink({ href, icon, label, description }: { href: string; icon: string; label: string; description: string }) {
  return (
    <Link
      href={href}
