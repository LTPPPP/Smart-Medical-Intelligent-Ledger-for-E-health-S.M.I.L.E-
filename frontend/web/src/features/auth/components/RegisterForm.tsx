            ...
            <div className="relative flex flex-1 flex-col items-center justify-center overflow-y-auto px-6 py-8 lg:px-12">
                ...
                >
                    ...
                    <button
                        ...
                        className="flex w-full items-center justify-center gap-3 rounded-full border py-2.5 font-inter text-sm font-medium text-smile-title transition-all duration-200 hover:-translate-y-0.5 hover:text-smile-primary hover:shadow-md disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:translate-y-0 disabled:hover:shadow-none"
                        style={{
                            borderColor: "var(--surface-card-border)",
