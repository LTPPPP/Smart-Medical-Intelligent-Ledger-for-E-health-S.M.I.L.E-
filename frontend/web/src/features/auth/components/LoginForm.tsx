	...
	return (
		<div className="relative flex h-screen overflow-hidden bg-background">
			...
			<div
				...
				style={{
					background:
						"linear-gradient(155deg, var(--color-smile-primary-dark) 0%, #2a6494 55%, var(--color-smile-primary) 100%)",
				}}
			>
				{/* Ambient glows */}
				...
				<div
					className="pointer-events-none absolute left-1/3 top-2/5 h-40 w-40 rounded-full blur-[60px]"
