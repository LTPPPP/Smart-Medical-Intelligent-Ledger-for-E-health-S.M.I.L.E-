    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <div className="relative">
                ...
                >
                    {show ? <Icon icon="lucide:eye-off" className="h-[18px] w-[18px]" /> : <Icon icon="lucide:eye" className="h-[18px] w-[18px]" />}
                </button>
            </div>
        </div>
    );
        ...
        <div className="flex items-center justify-center py-10">
            ...
            >
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="relative">
                            ...
                            <button
                                ...
                                className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground transition-colors hover:text-foreground dark:text-[#94A3B8] dark:hover:text-white"
                            >
                                {showCurrent ? <Icon icon="lucide:eye-off" className="h-[18px] w-[18px]" /> : <Icon icon="lucide:eye" className="h-[18px] w-[18px]" />}
                            </button>
                        </div>
                    </div>
                ...
                <div className="flex justify-end gap-4 px-8 pb-8 pt-0">
                    ...
                    >
                        <Icon icon="lucide:shield" className="h-[15px] w-[15px]" />
