    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-full bg-teal-100 flex items-center justify-center">
          <Icon icon="tabler:file-certificate" className="text-teal-600" width={20} />
        </div>
        <div>
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Dr. {plan.doctorName} · {new Date(plan.createdAt).toLocaleDateString()}
                  </p>
                </div>
        ...
        <div className="glass-smile rounded-xl p-6 border-2 border-teal-200 space-y-4">
          ...
          <label className="flex items-start gap-3 cursor-pointer">
            ...
            <span className="text-sm">
              I have read and understood the treatment plan. I consent to the proposed
              procedures and acknowledge the associated risks as explained by my doctor.
            </span>
          </label>
      ...
      {plans.length === 0 && (
        <div className="nm-sunken rounded-xl p-8 text-center">
          <Icon icon="tabler:file-off" className="mx-auto text-slate-400 mb-3" width={40} />
