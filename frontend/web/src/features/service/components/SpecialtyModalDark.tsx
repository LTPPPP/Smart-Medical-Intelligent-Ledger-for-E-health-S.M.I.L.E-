...
export function SpecialtyModalDark({
  ...
  const set = <K extends keyof SpecialtyFormValues>(k: K, v: SpecialtyFormValues[K]) =>
    setForm((f) => ({ ...f, [k]: v }));
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <Field label="Display order">
              <input
                ...
                placeholder="0"
                onChange={(e) => set('display_order', e.target.value ? Number(e.target.value) : null)}
              />
            </Field>
            <Field label="Status">
              <button
              ...
              >
                ...
                <span
                  ...
                  style={{ background: form.is_active ? BLUE : 'rgba(255,255,255,0.15)' }}
                >
                  <span
