...
export function ServiceFilters({ filters, onFilterChange, onReset }: ServiceFiltersProps) {
  return (
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={(e) => onFilterChange('service_name', e.target.value || undefined)}
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => {
              ...
              onFilterChange('isActive', val === '' ? undefined : val === 'true');
            }}
