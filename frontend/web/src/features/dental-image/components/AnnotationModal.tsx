  ...
  return (
    <section className="rounded-[20px] border p-6 [border-color:var(--surface-card-border)] [background:var(--surface-panel-bg)]">
        ...
        <div className="mb-5 flex flex-col gap-2">
          ...
          {annotations.map((a) => (
            <div key={a.annotation_id} className="flex items-start justify-between gap-3 rounded-xl border p-3 [border-color:var(--surface-panel-border)] [background:var(--surface-card-bg)]">
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-2">
                  {a.annotation_type && <span className="rounded-full bg-smile-primary-light px-2 py-0.5 text-[11px] text-smile-primary">{a.annotation_type}</span>}
                  <span className="text-xs text-smile-description">{actorLabel(a.annotated_by)}</span>
                </div>
        ...
        {/* Add */}
        <form onSubmit={add} className="flex flex-col gap-3 border-t pt-4 [border-color:var(--surface-panel-border)]">
