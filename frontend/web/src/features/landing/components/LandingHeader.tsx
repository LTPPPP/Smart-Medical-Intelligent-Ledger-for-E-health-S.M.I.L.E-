								...
								{dropdownOpen && (
									...
									>
										...
										<div
											...
											style={{
												borderBottom: "1px solid var(--surface-panel-border)",
											}}
										>
											{user.avatarUrl ? (
												<Image
										...
										<div className="p-1.5">
											{NAV_ITEMS.map((item) => (
												<Link
													key={item.href}
													href={item.href}
													className={`flex items-center gap-3 rounded-xl px-3 py-2.5 font-inter text-sm transition-all hover:text-smile-primary ${
														pathname === item.href
										...
										<div className="p-1.5">
											<button
												...
												className={`flex w-full items-center gap-3 rounded-xl px-3 py-2.5 font-inter text-sm transition-all disabled:opacity-60 ${
													confirmingLogout
