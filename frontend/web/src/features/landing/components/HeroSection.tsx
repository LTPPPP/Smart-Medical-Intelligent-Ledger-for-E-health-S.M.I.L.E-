	...
	return (
		<section className="relative overflow-hidden px-4 pb-20 pt-14 md:px-6">
			...
			<div className="relative mx-auto max-w-[1280px]">
				...
				>
					<div className="flex items-center gap-2.5 rounded-full border border-smile-primary/25 bg-smile-primary/5 px-6 py-2.5 backdrop-blur-sm dark:border-[rgba(56, 189, 248,0.3)] dark:bg-[rgba(56, 189, 248,0.06)]">
						<Icon
