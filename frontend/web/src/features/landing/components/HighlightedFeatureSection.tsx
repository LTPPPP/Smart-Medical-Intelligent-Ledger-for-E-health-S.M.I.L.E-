			...
			<div className="mx-auto grid max-w-[1280px] gap-6 lg:grid-cols-[1fr_362px]">
				...
				<div
					...
					style={{
						...
						boxShadow:
							"0 0 80px rgba(146,205,253,0.06), var(--surface-panel-shadow)",
					}}
				>
					{/* Top shimmer */}
					...
					<div className="relative z-10">
						<div className="mb-5 inline-flex items-center gap-2 rounded-full border border-smile-primary/25 bg-smile-primary/5 px-4 py-1.5 dark:border-[rgba(146,205,253,0.3)] dark:bg-[rgba(146,205,253,0.06)]">
							<Icon
				...
				<div className="flex flex-col gap-6">
					...
					<div
						...
						style={{
							...
							boxShadow:
								"0 0 50px rgba(56, 189, 248,0.05), var(--surface-panel-shadow)",
							minHeight: "188px",
						}}
					>
					...
					<div
						...
						style={{
							...
							border: "1px solid rgba(146,205,253,0.2)",
							boxShadow:
								"0 0 50px rgba(146,205,253,0.05), var(--surface-panel-shadow)",
							minHeight: "188px",
						}}
					>
						...
						<div className="absolute left-4 top-4 opacity-70">
							<Image
								...
								className="h-auto w-auto object-contain"
								style={{
									filter: "drop-shadow(0 0 10px rgba(146,205,253,0.3))",
								}}
							/>
						</div>
