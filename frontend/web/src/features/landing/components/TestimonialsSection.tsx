...
const testimonials = [
    ...
    },
    {
        ...
        rating: 5,
        accent: "#60A5FA",
        quote: "The before/after tracking with AI photo analysis was such a nice touch. I actually looked forward to my follow-up appointments.",
    },
    {
        name: "Grace Le",
        role: "Patient · Braces",
        ...
        rating: 4,
        accent: "#92CDFD",
        quote: "Two-year treatment, zero paperwork hassle. Every visit, every note and every invoice was right there when I needed it.",
    },
] as const;
    ...
    return (
        ...
        >
            <div
                ...
                style={{ background: `radial-gradient(120% 100% at 0% 0%, ${testimonial.accent}14, transparent 60%)` }}
            />
            ...
            <div className="relative z-10 mt-6 flex items-center justify-between gap-3 border-t pt-5" style={{ borderColor: "var(--surface-panel-border)" }}>
            ...
            <div className="mx-auto max-w-[1280px]">
                ...
                >
                    <div className="flex items-center gap-2 rounded-full border border-smile-primary/10 bg-smile-primary/[0.04] px-5 py-2 backdrop-blur-sm dark:border-white/[0.10] dark:bg-white/[0.04]">
                        <Icon icon="lucide:heart-handshake" width={14} className="text-smile-primary dark:text-[#92CDFD]" />
