...
export const ClinicForm = ({ clinic, onSubmit, onCancel, isSubmitting }: ClinicFormProps) => {
    ...
    const validate = () => {
        ...
        if (!clinic && !formData.clinicCode.trim()) newErrors.clinicCode = 'Clinic code is required';
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <Input
                            ...
                            disabled={!!clinic}
                        />
                        {errors.clinicCode && <p className="text-red-500 text-xs mt-1">{errors.clinicCode}</p>}
                    </div>
                ...
                <div className="space-y-2">
                    {DAYS_OF_WEEK.map((day) => (
                        <div key={day} className="flex items-center gap-4">
                            <label className="w-24 capitalize font-medium text-sm">{day}:</label>
                            <Input
                                label=""
