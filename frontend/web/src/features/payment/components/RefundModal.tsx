                ...
                >
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            >
                                <Icon icon="lucide:arrow-left" width={16} style={{ color: colors.error }} />
                            </div>
                            <h2
                                style={{
                        ...
                        >
                            <Icon icon="lucide:x" width={14} style={{ color: colors.textTertiary }} />
                        </button>
                    </div>
                    ...
                    <div style={{ padding: "20px 24px" }} className="flex flex-col gap-4">
                        ...
                        >
                            <Icon icon="lucide:alert-circle" width={14} style={{ color: colors.success, flexShrink: 0 }} />
