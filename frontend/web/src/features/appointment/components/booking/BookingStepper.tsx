...
import { useBookingStore, type BookingStep } from "@/features/appointment/stores/useBookingStore";
                    ...
                    <div key={step.id} className="relative z-10 flex flex-col items-center gap-2">
                        ...
                        >
                            {isCompleted ? (
                                ...
                                >
                                    <Icon icon="lucide:check" width={16} style={{ color: colors.success }} strokeWidth={2.5} />
                                </motion.div>
                            ) : (
                                <span
                                    style={{
