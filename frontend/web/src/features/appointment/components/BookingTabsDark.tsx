					...
					return (
						<button
							...
							className={`flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-semibold transition ${
								active
									? ""
									: "text-smile-description [background:var(--surface-panel-bg)] [border-color:var(--surface-panel-border)]"
							}`}
							style={
								active
									? {
			...
			{tab === "outside" && (
				<div className="flex items-start gap-2 rounded-xl border border-[rgba(146,205,253,0.3)] bg-[rgba(146,205,253,0.08)] px-4 py-3 text-sm text-[#CBE6FF]">
					...
					<span>
						...
						business hours. The appointment may require special staffing
