...
import { Camera, Edit3, Lock, Mail, Phone, MapPin, User, Stethoscope } from "lucide-react";
...
export function EditProfile({
    ...
    function set<K extends keyof EditableProfile>(key: K, val: EditableProfile[K]) {
    ...
    return (
        <div className="flex gap-6">
            {/* ── Left: Avatar card ─────────────────────────────── */}
            <div className="relative w-[277px] shrink-0 rounded-[20px] border bg-card text-card-foreground shadow-sm dark:border-white/[0.1] dark:bg-transparent dark:shadow-[0_8px_32px_rgba(0,0,0,0.3)] dark:backdrop-blur-[10px]" style={typeof window !== "undefined" && document.documentElement.classList.contains("dark") ? { background: "rgba(255,255,255,0.03)" } : {}}>
                {/* Top corner glow */}
                <div
                    ...
                    <div className="group relative mb-4 cursor-pointer">
                        ...
                        <div className="relative flex h-32 w-32 items-center justify-center rounded-full border-2 p-1 dark:border-[rgba(146,205,253,0.3)]">
                            <div className="flex h-full w-full items-center justify-center rounded-full bg-muted opacity-80 dark:bg-[#272A2D]">
                                <User className="h-12 w-12 text-muted-foreground dark:text-[#C1C7CF]" />
                            </div>
                            {/* Edit overlay */}
                ...
                {/* Divider */}
                <div className="mx-8 my-6 h-px" style={{ background: "linear-gradient(90deg,rgba(255,255,255,0) 0%,rgba(128,128,128,0.15) 50%,rgba(255,255,255,0) 100%)" }} />
            ...
            <div className="flex flex-1 flex-col rounded-[20px] border bg-card text-card-foreground shadow-sm p-8 dark:border-white/[0.1] dark:bg-transparent dark:shadow-[0_8px_32px_rgba(0,0,0,0.3)] dark:backdrop-blur-[10px]" style={typeof window !== "undefined" && document.documentElement.classList.contains("dark") ? { background: "rgba(255,255,255,0.03)" } : {}}>
                ...
                <div className="mb-4 flex items-center gap-2">
                    <User className="h-[17px] w-[17px] text-[#92CDFD]" />
                    <span
                ...
                <div className="mb-8 h-px" style={{ background: "linear-gradient(90deg,rgba(128,128,128,0.15) 0%,rgba(255,255,255,0) 100%)" }} />
                ...
                <div className="mb-8 grid grid-cols-2 gap-6">
                    <FormField label={t("profile.dob", "Date of Birth")}>
                        <TextInput value={form.dob} onChange={(v) => set("dob", v)} placeholder="MM/DD/YYYY" />
                    </FormField>
                ...
                {/* Section: Contact */}
                <div className="mb-4 flex items-center gap-2">
                    <Phone className="h-[15px] w-5 text-[#92CDFD]" />
                    <span
                        className="text-xl text-foreground dark:text-white"
                        style={{ fontFamily: "var(--font-public-sans)" }}
                    >
                ...
                <div className="mb-4 flex items-center gap-2">
                    <Lock className="h-[17.5px] w-[13px] text-muted-foreground/60 dark:text-[#475569]" />
                    <span
                ...
                <div className="mb-8">
                    <FormField label={t("profile.email", "Primary Email")} readOnly>
                        <div className="relative">
                            ...
                            <Lock className="absolute right-4 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-muted-foreground/60 dark:text-[#64748B]" />
                        </div>
                    </FormField>
                </div>
                ...
                <div className="mt-auto flex justify-end gap-4 border-t pt-6 dark:border-white/[0.1]">
                    <button
                        ...
                        style={{ fontFamily: "var(--font-space-grotesk)", letterSpacing: "0.35px" }}
                    >
                    ...
                    <button
                        ...
                        style={{
                            background: "#92CDFD",
                            boxShadow: "0 0 15px rgba(146,205,253,0.2), inset 0 0 10px rgba(255,255,255,0.5)",
