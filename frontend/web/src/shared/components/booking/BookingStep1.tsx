...
import { Building2, Stethoscope, UserRound, ChevronRight } from "lucide-react";
import { motion } from "framer-motion";
import { useTranslation } from "@/hooks";
import { useBookingStore, type PathType } from "@/stores/useBookingStore";
import { colors, fonts, glassCard, btnPrimary, radii } from "@/styles/tokens";
import { GlassCard, SectionHeading } from "@/components/shared/GlassUI";
...
export function BookingStep1() {
    ...
    const PATH_CONFIGS: { id: PathType; icon: React.ReactNode; title: string; desc: string }[] = [
        { id: "facility", icon: <Building2 size={24} style={{ color: colors.primary }} />, title: t("booking.step1.byFacility", "By Facility"), desc: t("booking.step1.byFacilityDesc", "Choose a clinic or hospital location near you") },
        { id: "specialty", icon: <Stethoscope size={24} style={{ color: colors.primary }} />, title: t("booking.step1.bySpecialty", "By Specialty"), desc: t("booking.step1.bySpecialtyDesc", "Find the right specialist for your needs") },
        { id: "doctor", icon: <UserRound size={24} style={{ color: colors.primary }} />, title: t("booking.step1.byDoctor", "By Doctor"), desc: t("booking.step1.byDoctorDesc", "Search for a specific doctor you prefer") },
    ];
