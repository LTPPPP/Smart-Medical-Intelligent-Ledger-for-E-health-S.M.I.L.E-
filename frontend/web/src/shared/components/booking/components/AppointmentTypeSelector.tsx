...
export function AppointmentTypeSelector({ value, onChange }: AppointmentTypeSelectorProps) {
    ...
    const TYPES = [
        { id: "in-person" as AppointmentType, icon: <User size={18} />, label: t("booking.step3.inPerson", "In-Person"), desc: t("booking.step3.inPersonDesc", "Visit the clinic") },
        { id: "phone" as AppointmentType, icon: <Phone size={18} />, label: t("booking.step3.phoneCall", "Phone Call"), desc: t("booking.step3.phoneCallDesc", "Remote consultation") },
        { id: "video" as AppointmentType, icon: <Video size={18} />, label: t("booking.step3.videoCall", "Video Call"), desc: t("booking.step3.videoCallDesc", "Online visit") },
    ];
