...
export const EXAMINATION_ROLES: UserRole[] = [ROLE.ADMIN, ROLE.DOCTOR, ROLE.NURSE, ROLE.MANAGER];
...
export const DENTAL_IMAGE_ROLES: UserRole[] = [ROLE.ADMIN, ROLE.DOCTOR, ROLE.NURSE, ROLE.MANAGER];
...
export const LEAVES_ROLES: UserRole[] = [ROLE.ADMIN, ROLE.DOCTOR, ROLE.RECEPTIONIST, ROLE.NURSE, ROLE.MANAGER];

/** Front-desk actions (appointment check-in) — mirrors isPrivilegedStaffRole in appointments.service.ts. */
export const FRONT_DESK_ROLES: UserRole[] = [ROLE.ADMIN, ROLE.RECEPTIONIST, ROLE.NURSE, ROLE.MANAGER];

/** Work-shift catalog management — mirrors write roles in work-shifts.controller.ts. */
export const WORK_SHIFT_ROLES: UserRole[] = [ROLE.ADMIN, ROLE.DOCTOR, ROLE.RECEPTIONIST, ROLE.MANAGER];
