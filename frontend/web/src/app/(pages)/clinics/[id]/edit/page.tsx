  ...
  return (
    <AppShell>
      <div className="mx-auto flex w-full max-w-3xl flex-col gap-6 px-8 py-10">
        <button onClick={() => router.push(ROUTES.CLINIC_DETAIL(id))} className="flex items-center gap-2 text-sm text-[#C1C7CF] transition hover:text-white">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-[#C1C7CF]">Update clinic information.</p>
        </div>

        <div className={`${cardBase} p-6`}>
          {isLoading || !clinic ? (
            <div className="flex items-center justify-center gap-2 py-10 text-[#C1C7CF]">
