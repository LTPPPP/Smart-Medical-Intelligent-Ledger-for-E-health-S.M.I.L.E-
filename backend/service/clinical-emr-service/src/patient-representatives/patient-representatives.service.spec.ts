...
describe('PatientRepresentativesService', () => {
  ...
  function createService() {
    ...
    return { service, representativesRepository };
  }

  it('should create a verified legal representative with explicit consent scopes', async () => {
  ...
  it('should update identity and authorization fields for an existing representative', async () => {
    const { service, representativesRepository } = createService();
