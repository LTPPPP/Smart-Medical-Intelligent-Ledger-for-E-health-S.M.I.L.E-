 ...
 *   treatment_plans.status         20 -> 11  PlanStatus, 'in_progress'
 ...
 *     treatment_plans.{sent_via,acceptance_scope},
...
export class TightenColumnWidths1784600000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "treatment_plans" ALTER COLUMN "status" TYPE VARCHAR(11)`,
    );
