...
describe('appointment scheduling policy', () => {
  it('adds arrival grace, service duration, and doctor break', () => {
  ...
  it('generates 15-minute starts whose full occupied interval fits the shift', () => {
    expect(generateCandidateStarts('09:00', '12:00', 150)).toEqual(['09:00']);
  });

  it('uses half-open intervals so an appointment may start at the prior end', () => {
  ...
  it('rejects non-positive service durations', () => {
