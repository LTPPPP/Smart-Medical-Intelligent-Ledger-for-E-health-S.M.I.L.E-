...
export class ClinicsController {
  ...
  @ApiOperation({ summary: 'UC-023: List clinics' })
  ...
  @Get(':id')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'UC-024: Get clinic detail' })
  @ApiResponse({ status: 200, description: 'Clinic detail with treatment rooms' })
